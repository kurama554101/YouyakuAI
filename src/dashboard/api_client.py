...
class ApiClient():
    ...
    def post_body_to_summarize(self, body_text:str):
        ...
        try:
            ...
            raise ApiClientError("[ApiClientError] http error is occured! error detail is {}".format(err))
        except urllib.error.URLError as err:
            raise ApiClientError("[ApiClientError] url error is occured! error detail is {}".format(err))
    ...
    def __get_url(self, request_name:str) -> str:
        return "http://{}:{}/{}/".format(self.__config.host, self.__config.port, request_name)
