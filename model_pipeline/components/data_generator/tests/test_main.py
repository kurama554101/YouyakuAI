import unittest
from data_generator import OutputDestinations, main, write_csv, ComponentArguments
import os
import shutil
import pandas as pd
...
class TestDataGenerator(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.output_destinations = OutputDestinations(train_data_path=os.path.join(self.output_folder, "train.csv"),
    ...
    def test_main(self):
        ...
        # csvが出来ていることを検証
        self.assertTrue(os.path.exists(self.output_destinations.train_data_path))
        self.assertTrue(os.path.exists(self.output_destinations.val_data_path))
        self.assertTrue(os.path.exists(self.output_destinations.test_data_path))
