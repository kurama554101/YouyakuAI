...
# youyaku_ai_model_pipeline documentation build
...
from youyaku_ai_model_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "youyaku_ai_model_pipeline"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "youyaku_ai_model_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "youyaku_ai_model_pipeline.tex",
        "youyaku_ai_model_pipeline Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "youyaku_ai_model_pipeline",
        "Project youyaku_ai_model_pipeline codebase.",
        "Data-Science",
    )
]
